            ...
            <div class="input-group">
              ...
              ?>
                  ...
                  <div  class="table-responsive">
                    ...
                    class="btn btn-inverse-primary btn-rounded btn-fw float-right" href="cetak_pendaftar.php" target="_blank">
                    ...
                    <tr>
                      ...
                      $queryAdminAll = "SELECT * FROM pendaftar";
                      ...
                      if(isset($_GET['pencarian'])){
                          ...
                          $cariData = mysqli_query($koneksi, $queryAdmin);
                          // $cariData = mysqli_query($koneksi, $queryAdminAll);  
                      }
                      //INNER JOIN END
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $no; ?></td>
                          <td><?php echo $name;?></td>
                          <td class="text-primary"><?php echo $jobname;?></td>
                          <td><?php echo $date; ?></td>
                          <td>
                            <a href="detail_pendaftar.php?id=<?php echo $idreg; ?>" type="button" class="btn btn-info ">
                              <i class="ti-info btn-icon-prepend"> Detail</i> 
                            </a> &nbsp;&nbsp;&nbsp; 
                            <a href="hapus_pendaftar.php?id=<?php echo $idreg; ?>" type="button" class="btn btn-danger" 
                              onclick="return confirm('Delete data ini?')">
                              <i class="ti-alert btn-icon-prepend"> Hapus</i>
                            </a>
                          </td>
                        </tr>
                      </tbody>
