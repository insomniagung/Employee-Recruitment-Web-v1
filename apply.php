...
$data = mysqli_fetch_array($getdata);
                    ...
                    if(isset($_POST['apply'])){
                        ...
                        elseif(!in_array($ext1,$ekstensi1)){ //JIKA Sertifikat tidak diinput
                            ...
                            $insertdata = mysqli_query($koneksi,"INSERT INTO pendaftar (idreg,idjob,name,gender,tgl_lahir,alamat,email,telp,pend_terakhir,url_linkedin,url_cv,ijazah,sim)
                                values('$idreg','$idjob','$name','$gender','$tgl_lahir','$alamat','$email','$telpon','$pend_terakhir','$linkedin','$cv','$xx','$xx2')");
                        ...
                        elseif(!in_array($ext2,$ekstensi2)){
                            ...
                            if($ukuran < 2048 * 1000){ //2MB
                                ...
                                $insertdata = mysqli_query($koneksi,"INSERT INTO pendaftar (idreg,idjob,name,gender,tgl_lahir,alamat,email,telp,pend_terakhir,url_linkedin,url_cv,ijazah,sertifikat,sim)
                                values('$idreg','$idjob','$name','$gender','$tgl_lahir','$alamat','$email','$telpon','$pend_terakhir','$linkedin','$cv','$xx','$xx1','$xx2')");
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="benefit.php" class="nav-item nav-link">Keuntungan</a>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>Kantor Pusat</p><p>
