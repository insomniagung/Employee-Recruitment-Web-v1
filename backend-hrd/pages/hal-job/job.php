            ...
            <div class="col-xl-13 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a class="btn btn-info btn-rounded btn-fw float-left" href="tambah_job.php"><i class="ti-file btn-icon-prepend">
                  </i> Create New </a>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td align="left">
                            ...
                            <a href="hapus_job.php?id=<?php echo $idjob; ?>" type="button" title="Hapus Data" class="btn btn-danger btn-icon-text" onclick="return confirm('Delete data ini?')"><i class="ti-alert btn-icon-prepend"></i> Delete
                            </a>
                          </td>
                        </tr>
                      </tbody>
